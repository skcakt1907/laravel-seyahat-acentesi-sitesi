    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-md-12">
                <div class="wrapper">
                    <h1 class="heading">Tekliflerim</h1>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="col-md-12 border-left-3 main-content">
                        <div class="title-area mb-4">
                            ...
                            <div class="pull-right">
                                ...
                                <a href="tekliflerim.html">Tekliflerim </a>
                            </div>
                        </div>
                        <table width="100%" id="tekliflerim" class="table table-bordered table-striped">
                            <thead>
                            <tr>
...
<style>
    @media only screen and (max-width: 1024px) and (min-width: 320px){
        ...
        #tekliflerim thead tr {
            position: absolute;
            top: -9999px;
            left: -9999px;
        }

        #tekliflerim tr { margin-bottom:10px;border-bottom: 1px solid #ccc; }
        ...
        #tekliflerim td:nth-of-type(1):before { content: "<?=@$dil['txt40'];?>"; }
        #tekliflerim td:nth-of-type(2):before { content: "<?=@$dil['txt36'];?>"; }
        #tekliflerim td:nth-of-type(3):before { content: "<?=@$dil['txt186'];?>"; }
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        var dataTable=$('#tekliflerim').DataTable({
            "processing": true,
            "serverSide":true,
            "ajax":{
                url:"<?php echo tema;?>/data/tekliflerim.php",
                type:"post"
            },
            "order": [
                [ 0, "desc" ]
