...
{
	$Sorgu = $db->prepare("SELECT * FROM hostingler WHERE id = ? AND durum = ? AND dil = ?");
	$Sorgu->execute(array($_GET['id'],1,$_SESSION['k_dil']));
	if($Sorgu->rowCount())
	{
		$Sonuc 	= $Sorgu->fetch(PDO::FETCH_ASSOC);

        if(isset($_SESSION['multiyil'])){
            $Sonuc['tutar'] = $Sonuc[$_SESSION['multiyil']];
        }
                ...
                <div class="col-md-9">
                    <div class="col-md-12 main-content">
                        ...
                        <form action="_class/site_islem.php" method="POST" id="paketsatinal">
                             <table width="100%" class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-center">
                                        <?php if((isset($indirimsiz)) && ($indirimsiz!=$Sonuc['tutar'])){?>
                                            <strong style="text-decoration: line-through;color: red;"><?=$indirimsiz;?> TL.</strong>
                                        <?php } ?>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-center">
                                        <?php if((isset($indirimsiz)) && ($indirimsiz!=$Sonuc['tutar'])){?>
                                            <strong style="text-decoration: line-through;color: red;">
                                                <?php 
                                                $fiyat = ($indirimsiz * 20) / 100;
                                                ?>
                                                <?php echo my_number_format($fiyat);?> TL.</strong>
                                        <?php } ?>
                                        <?php 
                                    ...
                                    <td class="align-middle text-center">
                                        <?php if((isset($indirimsiz)) && ($indirimsiz!=$Sonuc['tutar'])){?>
                                            <strong style="text-decoration: line-through;color: red;">
                                                <?php 
                                                $fiyat = ($indirimsiz * 20) / 100;
                                                $fiyat_toplam = $fiyat + $indirimsiz;
                                                ?>
                                                <?php echo my_number_format($fiyat_toplam);?> TL.</strong>
                                        <?php } ?>
                                        <?php 
                                        $fiyat = ($Sonuc['tutar'] * 20) / 100;
                                ...
                                <tr>
                                    <td colspan="3" class="align-middle">
                                        ...
                                        <input type="hidden" name="siparisid" value="<?php echo $Sonuc['id']; ?>" />
                                            <input type="hidden" name="url" value="hosting-satinal/<?php echo $Sonuc['id']; ?>.html" />
                        ...
                        <?php if($_SESSION['siparis'] == "havale"){?>
                            ...
                            <?php $Sonuc['tutar'] = $Sonuc['tutar'] + 00 ?>
                            <!-- Havale İle Ödeme -->
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form action="_class/site_islem.php" method="post" autocomplete="off">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <input type="hidden" name="satilan" value="hosting" />
                                                <input type="hidden" name="url" value="hosting-satinal/<?php echo $Sonuc['id']; ?>.html" />
...
## Kullanıcının IP adresi
                                                    ...
                                                    $request->setPrice(floor($payment_amount / 100));
                                                    $request->setPaidPrice(floor($payment_amount / 100));
                                                    ...
                                                    $firstBasketItem->setPrice(floor($payment_amount / 100));
