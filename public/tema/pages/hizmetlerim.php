    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-md-12">
                <div class="wrapper">
                    <h1 class="heading"><?=@$dil['txt305'];?></h1>
                </div>
            </div>
        </div>
    </div>
					...
					<div class="col-md-12 border-left-3 main-content">
						<div class="title-area mb-4">
							...
							<div class="pull-right">
								...
								<a href="hizmetlerim.html"><?=@$dil['txt305'];?> </a>
							</div>
						</div>
						<table width="100%" id="hizmetlerim" class="table table-bordered table-striped">
							<thead>
							<tr>
								<th scope="col" class="text-left"><?=@$dil['txt40'];?></th>
								<th scope="col" class="text-center"><?=@$dil['txt36'];?></th>
								<th scope="col" class="text-center"><?=@$dil['txt186'];?></th>
							</tr>
							</thead>
							<tbody>							
...
@media only screen and (max-width: 1024px) and (min-width: 320px){
    ...
    #hizmetlerim thead tr { 
        position: absolute;
        top: -9999px;
        left: -9999px;
    }
     
    #hizmetlerim tr { margin-bottom:10px;border-bottom: 1px solid #ccc; }
    ...
    #hizmetlerim td:nth-of-type(1):before { content: "<?=@$dil['txt40'];?>"; }
    #hizmetlerim td:nth-of-type(2):before { content: "<?=@$dil['txt36'];?>"; }
    #hizmetlerim td:nth-of-type(3):before { content: "<?=@$dil['txt186'];?>"; }

}
</style>
<script type="text/javascript">
$(document).ready(function(){
	var dataTable=$('#hizmetlerim').DataTable({
		"processing": true,
		"serverSide":true,
		"ajax":{
			url:"<?php echo tema;?>/data/hizmetlerim.php",
			type:"post"
		},		
		"order": [
			[ 0, "desc" ]
		...
		"columnDefs": [
			...
			{  "className": "text-left align-middle", targets: [0,2] },
