        ...
        <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="bh-contact-card">
                    ...
                    <h5 style="font-size:16px;font-weight:700;color:var(--bh-dark);margin-bottom:6px;">{{ __('Phone') }}</h5>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="bh-contact-card">
                    ...
                    <h5 style="font-size:16px;font-weight:700;color:var(--bh-dark);margin-bottom:6px;">{{ __('Email') }}</h5>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="bh-contact-card">
                    ...
                    <h5 style="font-size:16px;font-weight:700;color:var(--bh-dark);margin-bottom:6px;">{{ __('Address') }}</h5>
            ...
            <div class="col-lg-8">
                <div class="bh-contact-form-card">
                    ...
                    <form action="{{ route('contact.submit') }}" method="POST" class="bh-form">
                        @csrf
                        <div style="position:absolute;left:-9999px;height:0;width:0;overflow:hidden;" aria-hidden="true"><input type="text" name="hp_field_xz9" tabindex="-1" autocomplete="off" value=""></div>
                        <div class="row">
                            ...
                            <div class="col-12 mb-3">
                                <textarea name="message" class="form-control" rows="8" placeholder="{{ __('Your message...') }}" required style="height:auto;min-height:160px;"></textarea>
                            </div>
                            <div class="col-12">
