...
@section('title', 'Transfer Güzergahı Ekle')

@section('content')
<div class="admin-table-card" style="max-width:700px;">
    <div class="admin-table-header">
        <h5><i class="fas fa-plus-circle" style="color:var(--admin-primary);margin-right:8px;"></i> Transfer Güzergahı Ekle</h5>
        ...
        <form action="{{ route('admin.transfers.store') }}" method="POST">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="from_location" class="settings-input" value="{{ old('from_location', 'Dalaman') }}" required placeholder="e.g. Dalaman">
                </div>
                <div class="col-md-6 mb-3">
                    <label class="settings-label">Varış Noktası *</label>
                    <input type="text" name="to_location" class="settings-input" value="{{ old('to_location') }}" required placeholder="e.g. Fethiye">
                </div>
            </div>

            <div class="mb-3">
                <label class="settings-label">Görünen Başlık <small style="color:var(--admin-text-light);font-weight:400;">(boş bırakılırsa otomatik oluşturulur)</small></label>
